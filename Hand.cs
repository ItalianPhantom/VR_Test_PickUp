...
public class Hand : MonoBehaviour {
	...
	void Update () {
        if (heldObject) // Check if there is a held object already in hand
        {
            ...
            if (controller.controller.GetPressUp(Valve.VR.EVRButtonId.k_EButton_SteamVR_Trigger)) // Check if the trigger is released
            {
        ...
        {
            if (controller.controller.GetPressDown(Valve.VR.EVRButtonId.k_EButton_SteamVR_Trigger)) // Check if the trigger is being pressed
            {
